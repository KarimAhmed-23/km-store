...
import HeroSlider from './HeroSlider';
 ...
 function Home() {
  ...
  const [data, isLoaded, error] = useGetApi('https://ecommerce.routemisr.com/api/v1/products?limit=15&&category[in]=6439d5b90049ad0b52b90048'); 
  ...
  return (
    <>
      ...
      <section className="section-style banner-section py-0">
        ...
        <Link to={"/categories/6439d5b90049ad0b52b90048/Men's Fashion"}>
          <img className='w-100 img-fluid' src={require("../../assets/images/banner-4.jpg")} alt='banner'/>
        </Link>
      ...
      <section className='section-style products-slider-section'>
        <div className='container'>
          ...
          <div className='slider-container products-slider-container'>
            <ProductsSlider items={`https://ecommerce.routemisr.com/api/v1/products?category[in]=6439d2d167d9aa4ca970649f`}/>
